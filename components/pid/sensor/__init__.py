...
PID_CLIMATE_SENSOR_TYPES = {
    ...
    "SMITH_PREDICTED_PV": PIDClimateSensorType.PID_SENSOR_TYPE_SMITH_PREDICTED_PV,
    "SMITH_MODEL_PV": PIDClimateSensorType.PID_SENSOR_TYPE_SMITH_MODEL_PV,
    "SMITH_MODEL_PV_DELAYED": PIDClimateSensorType.PID_SENSOR_TYPE_SMITH_MODEL_PV_DELAYED,
    "SMITH_COMPENSATION": PIDClimateSensorType.PID_SENSOR_TYPE_SMITH_COMPENSATION,
}
